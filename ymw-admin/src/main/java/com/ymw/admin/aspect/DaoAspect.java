...
public class DaoAspect {
    ...
    @Pointcut("execution(* com.ymw.*.dao..*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* com.ymw.*.dao..*.insert*(..))")
    public void daoCreate() {
    }

    @Pointcut("execution(* com.ymw.*.sevice..*.update*(..))")
    public void daoUpdateMp() {
    }

    @Pointcut("execution(* com.ymw.*.sevice..*.insert*(..))")
